...
export default function ActivityForm({activity: selectedActivitiy, closeForm, createOrEdit, submitting}: Props){

    const initialState = selectedActivitiy ?? {
        id:'',
        title:'',
        category:'',
        description:'',
    ...
    return(
        <Segment clearing>
            <Form onSubmit={handleSubmit} autoComplete='off'>
                ...
                <Form.TextArea placeholder='Descripttion' value={activity.description} name='description' onChange={handleInputChange}></Form.TextArea>
                <Form.Input placeholder='Caterory' value={activity.category} name='category' onChange={handleInputChange}></Form.Input>
